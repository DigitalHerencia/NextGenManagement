...
import { FanEngagementMetrics } from "@/components/dashboard/fan-engagement-metrics"
    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-gray-400">Welcome back, {tenant.name}</span>
        </div>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>You had 265 engagements in the last 24 hours.</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentActivity />
              </CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Track how your audience is interacting with your content.</CardDescription>
              </CardHeader>
              <CardContent className="pl-2">
